...
\begin{figure}[ht]
  ...
  by A.~W.~Brown and K.~C.~Wallnau, 1996, \textit{IEEE Software, 13}(5), p.~41. 
  Copyright 1996 by IEEE. Reprinted with permission.}
  \label{fig:framework}
\end{figure}
